...
# Generated by qmake (2.01a) (Qt 4.8.7) on: qua nov 27 10:06:06 2019
# Project:  ProxyUI.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/aracne1.0.0/ && $(COPY_FILE) --parents proxyui.h requisicao_proxy.hpp resposta_proxy.hpp servidor_proxy.hpp funcoes.hpp Spider.hpp analises.hpp .tmp/aracne1.0.0/ && $(COPY_FILE) --parents main.cpp proxyui.cpp analises.cpp requisicao_proxy.cpp resposta_proxy.cpp servidor_proxy.cpp Spider.cpp funcoes.cpp .tmp/aracne1.0.0/ && $(COPY_FILE) --parents proxyui.ui .tmp/aracne1.0.0/ && (cd `dirname .tmp/aracne1.0.0` && $(TAR) aracne1.0.0.tar aracne1.0.0 && $(COMPRESS) aracne1.0.0.tar) && $(MOVE) `dirname .tmp/aracne1.0.0`/aracne1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/aracne1.0.0
...
analises.o: analises.cpp analises.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o analises.o analises.cpp

requisicao_proxy.o: requisicao_proxy.cpp requisicao_proxy.hpp \
		funcoes.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o requisicao_proxy.o requisicao_proxy.cpp

resposta_proxy.o: resposta_proxy.cpp resposta_proxy.hpp \
		funcoes.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o resposta_proxy.o resposta_proxy.cpp

servidor_proxy.o: servidor_proxy.cpp servidor_proxy.hpp \
		requisicao_proxy.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o servidor_proxy.o servidor_proxy.cpp

Spider.o: Spider.cpp analises.hpp \
		Spider.hpp \
		servidor_proxy.hpp \
		requisicao_proxy.hpp \
		resposta_proxy.hpp \
...
funcoes.o: funcoes.cpp funcoes.hpp
